...
/**
 * Banner surface for the Drakkar sail: one group of 8 strips of 20x5 model pixels,
...
public class DrakkarSailBannerModel extends SailBannerModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition DrakkarSailBanner = partdefinition.addOrReplaceChild("DrakkarSailBanner", CubeListBuilder.create(), PartPose.offset(-11.325F, 24.0F, -6.6F));

        PartDefinition segment_0 = DrakkarSailBanner.addOrReplaceChild("segment_0", CubeListBuilder.create().texOffs(3, 3).addBox(0.0F, -4.7F, 0.0F, 0.0F, 5.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.55F, -62.2F, -4.4F, 0.0F, 0.0F, 0.7418F));
