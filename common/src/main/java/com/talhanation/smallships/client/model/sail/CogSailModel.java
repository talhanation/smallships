...
public class CogSailModel extends SailModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition CogSail = partdefinition.addOrReplaceChild("CogSail", CubeListBuilder.create(), PartPose.offset(-11.0F, 24.0F, 0.0F));
		...
		PartDefinition cube_r87 = segel_1_12.addOrReplaceChild("cube_r87", CubeListBuilder.create().texOffs(88, 0).addBox(-60.0F, -39.0F, 16.6905F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(88, 0).addBox(-71.0F, -39.0F, 16.6905F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(96, 47).addBox(-49.0F, -39.0F, 16.6905F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(94, 21).addBox(-38.0F, -39.0F, 16.6905F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(85, 3).addBox(-27.0F, -39.0F, 16.6905F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(96, 47).addBox(-16.0F, -39.0F, 16.6905F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(58.4F, -26.3067F, 36.3895F, 2.0595F, 0.0F, 0.0F));

		PartDefinition cube_r88 = segel_1_12.addOrReplaceChild("cube_r88", CubeListBuilder.create().texOffs(93, 47).addBox(-16.0F, -40.25F, 11.2888F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(91, 22).addBox(-27.0F, -40.25F, 11.2888F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(93, 48).addBox(-38.0F, -40.25F, 11.2888F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(85, 3).addBox(-49.0F, -40.25F, 11.2888F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(91, 22).addBox(-60.0F, -40.25F, 11.2888F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(91, 22).addBox(-71.0F, -40.25F, 11.2888F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(58.4F, -28.4794F, 33.5112F, 1.8762F, 0.0F, 0.0F));

		PartDefinition cube_r95 = segel_1_12.addOrReplaceChild("cube_r95", CubeListBuilder.create().texOffs(65, 34).addBox(-60.0F, -34.7019F, 23.9822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 34).addBox(-71.0F, -34.7019F, 23.9822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(64, 21).addBox(-49.0F, -34.7019F, 23.9822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(66, 0).addBox(-38.0F, -34.7019F, 23.9822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(79, 19).addBox(-27.0F, -34.7019F, 23.9822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 0).addBox(-16.0F, -34.7019F, 23.9822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(58.4F, -20.7281F, 39.2678F, 2.2227F, 0.0F, 0.0F));

		PartDefinition rope_15 = segel_1_12.addOrReplaceChild("rope_15", CubeListBuilder.create(), PartPose.offsetAndRotation(40.0F, 1.0F, 18.0F, 1.309F, 0.8203F, 1.7628F));
		...
		PartDefinition rope_16 = segel_1_12.addOrReplaceChild("rope_16", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, 0.5F, 19.0F, 1.1781F, -0.7592F, -1.5708F));
		...
		PartDefinition cube_r64 = segel_1_11.addOrReplaceChild("cube_r64", CubeListBuilder.create().texOffs(82, 31).addBox(-16.0F, -43.5F, 4.75F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(76, 44).addBox(-60.0F, -43.5F, 4.75F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(76, 44).addBox(-71.0F, -43.5F, 4.75F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(64, 52).addBox(-49.0F, -43.5F, 4.75F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(92, 47).addBox(-38.0F, -43.5F, 4.75F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(92, 47).addBox(-27.0F, -43.5F, 4.75F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(58.4F, -34.7644F, 33.9338F, 1.7453F, 0.0F, 0.0F));

		PartDefinition cube_r65 = segel_1_11.addOrReplaceChild("cube_r65", CubeListBuilder.create().texOffs(80, 44).addBox(-16.0F, -44.0887F, -4.8822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(93, 25).addBox(-60.0F, -44.0887F, -4.8822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(93, 25).addBox(-71.0F, -44.0887F, -4.8822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(92, 48).addBox(-49.0F, -44.0887F, -4.8822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(66, 43).addBox(-38.0F, -44.0887F, -4.8822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(74, 32).addBox(-27.0F, -44.0887F, -4.8822F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(58.4F, -39.6813F, 33.5822F, 1.5272F, 0.0F, 0.0F));

		PartDefinition rope_19 = segel_1_11.addOrReplaceChild("rope_19", CubeListBuilder.create(), PartPose.offsetAndRotation(40.0F, 1.0F, 18.0F, 1.4224F, 0.8988F, 1.7628F));

		PartDefinition cube_r70 = rope_19.addOrReplaceChild("cube_r70", CubeListBuilder.create().texOffs(1, 26).addBox(44.5F, -0.5F, -17.5F, 15.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rope_20 = segel_1_11.addOrReplaceChild("rope_20", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, 0.5F, 19.0F, 1.2549F, -0.8454F, -1.5566F));
		...
		PartDefinition cube_r80 = sail_3_bottom.addOrReplaceChild("cube_r80", CubeListBuilder.create().texOffs(96, 55).addBox(-31.6F, -41.6933F, 18.2105F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(81, 17).addBox(-44.6F, -41.6933F, 18.2105F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(96, 23).addBox(-57.6F, -41.6933F, 18.2105F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(99, 23).addBox(-67.6F, -41.6933F, 18.2105F, 10.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(90, 20).addBox(-18.6F, -41.6933F, 18.2105F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(101, 13).addBox(-5.6F, -41.6933F, 18.2105F, 9.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(55.5F, -1.8067F, 44.7895F, 2.0595F, 0.0F, 0.0F));
		...
		PartDefinition cube_r43 = segel_1_8.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(96, 18).addBox(-60.0F, -40.9587F, -18.0289F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(96, 18).addBox(-71.0F, -40.9587F, -18.0289F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(91, 15).addBox(-49.0F, -40.9587F, -18.0289F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 41).addBox(-27.0F, -40.9587F, -18.0289F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(94, 19).addBox(-16.0F, -40.9587F, -18.0289F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(67, 52).addBox(-38.0F, -40.9587F, -18.0289F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(58.4F, -44.7113F, 34.1289F, 1.2217F, 0.0F, 0.0F));

		PartDefinition cube_r44 = segel_1_8.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(96, 42).addBox(-60.0F, -38.7859F, -21.6372F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(96, 42).addBox(-71.0F, -38.7859F, -21.6372F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(67, 15).addBox(-49.0F, -38.7859F, -21.6372F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(95, 37).addBox(-38.0F, -38.7859F, -21.6372F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(96, 39).addBox(-27.0F, -38.7859F, -21.6372F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 48).addBox(-16.0F, -38.7859F, -21.6372F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(58.4F, -47.7441F, 35.6572F, 1.0908F, 0.0F, 0.0F));

		PartDefinition rope_11 = segel_1_8.addOrReplaceChild("rope_11", CubeListBuilder.create(), PartPose.offsetAndRotation(40.0F, 1.0F, 18.0F, 1.4565F, 0.9684F, 1.7506F));
		...
		PartDefinition rope_12 = segel_1_8.addOrReplaceChild("rope_12", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, 0.5F, 19.0F, 1.2729F, -0.9301F, -1.5235F));
		...
		PartDefinition cube_r57 = sail_2_bottom.addOrReplaceChild("cube_r57", CubeListBuilder.create().texOffs(94, 33).addBox(-6.1F, -2.25F, -2.0F, 13.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				...
				.texOffs(86, 17).addBox(-36.1F, -2.25F, -2.0F, 17.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(93, 37).addBox(6.9F, -2.25F, -2.0F, 13.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(94, 24).addBox(19.9F, -2.25F, -2.0F, 13.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(24.6F, -7.5398F, 5.0626F, -2.2166F, 0.0F, 0.0F));
		...
		PartDefinition cube_r25 = segel_1_5.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(84, 52).addBox(-54.6F, -1.0F, -2.5F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(84, 52).addBox(-65.6F, -1.0F, -2.5F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(90, 10).addBox(-43.6F, -1.0F, -2.5F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 22).addBox(-32.6F, -1.0F, -2.5F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 14).addBox(-10.6F, -1.0F, -2.5F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(64, 56).addBox(-21.6F, -1.0F, -2.5F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(53.0F, -55.4356F, -0.4095F, 0.6545F, 0.0F, 0.0F));

		PartDefinition cube_r26 = segel_1_5.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(66, 53).addBox(-54.6F, -32.7857F, -32.1293F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(66, 53).addBox(-65.6F, -32.7857F, -32.1293F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(66, 45).addBox(-43.6F, -32.7857F, -32.1293F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 40).addBox(-32.6F, -32.7857F, -32.1293F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 33).addBox(-21.6F, -32.7857F, -32.1293F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(65, 24).addBox(-10.6F, -32.7857F, -32.1293F, 11.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(53.0F, -52.4943F, 39.4993F, 0.829F, 0.0F, 0.0F));

		PartDefinition rope_7 = segel_1_5.addOrReplaceChild("rope_7", CubeListBuilder.create(), PartPose.offsetAndRotation(40.0F, 1.0F, 18.0F, 1.4532F, 1.1163F, 1.7268F));

		PartDefinition cube_r27 = rope_7.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(18, 22).addBox(53.5237F, -0.4798F, -17.3901F, 16.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rope_8 = segel_1_5.addOrReplaceChild("rope_8", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, 0.5F, 19.0F, 1.1912F, -1.0973F, -1.4276F));
		...
		PartDefinition cube_r102 = sail_1_bottom.addOrReplaceChild("cube_r102", CubeListBuilder.create().texOffs(64, 32).addBox(-6.1F, -2.25F, -2.0F, 13.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
				...
				.texOffs(65, 51).addBox(-36.1F, -2.25F, -2.0F, 17.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(64, 48).addBox(6.9F, -2.25F, -2.0F, 13.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(67, 11).addBox(19.9F, -2.25F, -2.0F, 13.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(24.6F, -7.5398F, 5.0626F, -2.2166F, 0.0F, 0.0F));
		...
		PartDefinition cube_r113 = sail_end.addOrReplaceChild("cube_r113", CubeListBuilder.create().texOffs(64, 29).addBox(-6.1F, -3.25F, -3.0F, 13.0F, 6.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(63, 23).addBox(-19.1F, -3.25F, -3.0F, 13.0F, 6.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(69, 34).addBox(-35.1F, -3.25F, -3.0F, 16.0F, 6.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(66, 27).addBox(6.9F, -3.25F, -3.0F, 13.0F, 6.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(63, 11).addBox(19.9F, -3.25F, -3.0F, 12.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.25F, 0.0F, -2.2166F, 0.0F, 0.0F));

		PartDefinition ropes = CogSail.addOrReplaceChild("ropes", CubeListBuilder.create(), PartPose.offset(43.5F, -16.0F, 0.0F));

		PartDefinition rope_1 = ropes.addOrReplaceChild("rope_1", CubeListBuilder.create(), PartPose.offsetAndRotation(20.0F, -13.0F, 0.0F, 0.0F, -1.5708F, -0.8072F));
		...
		PartDefinition cube_r114 = rope_1.addOrReplaceChild("cube_r114", CubeListBuilder.create().texOffs(11, 23).addBox(34.5F, -0.5F, -17.5F, 15.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(8, 22).addBox(10.5F, -0.5F, -17.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.5F, 17.0F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition rope_2 = ropes.addOrReplaceChild("rope_2", CubeListBuilder.create(), PartPose.offsetAndRotation(-75.0F, -19.0F, 0.0F, 0.7766F, -1.5708F, 0.0F));
		...
		PartDefinition cube_r117 = rope_2.addOrReplaceChild("cube_r117", CubeListBuilder.create().texOffs(16, 28).addBox(34.5F, -0.5F, -17.5F, 15.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(16, 26).addBox(64.5F, -0.5F, -17.5F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
