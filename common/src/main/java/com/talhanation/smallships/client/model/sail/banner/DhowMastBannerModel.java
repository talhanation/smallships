 ...
 */
public class DhowMastBannerModel extends MastBannerModel {
    @SuppressWarnings("unused")
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(SmallShipsMod.MOD_ID, CogEntity.ID + "_mast_banner_model"), "main");

    public DhowMastBannerModel() {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition ModelDhowMastBanner = partdefinition.addOrReplaceChild("ModelDhowMastBanner", CubeListBuilder.create(), PartPose.offset(27.5F, -85.0F, -0.5F));

        PartDefinition cloth = ModelDhowMastBanner.addOrReplaceChild("cloth", CubeListBuilder.create(), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
