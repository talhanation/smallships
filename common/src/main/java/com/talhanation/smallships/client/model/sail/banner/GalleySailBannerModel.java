...
public class GalleySailBannerModel extends SailBannerModel {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SmallShipsMod.MOD_ID, GalleyEntity.ID + "_sail_banner_model"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition segment_0 = GalleySailBanner.addOrReplaceChild("segment_0", CubeListBuilder.create().texOffs(1, 1).addBox(42.0721F, -43.8508F, 4.3891F, 20.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.7411F, 2.5259F, -4.1251F, 0.1484F, -0.1571F, 0.0F));

        PartDefinition segment_1 = segment_0.addOrReplaceChild("segment_1", CubeListBuilder.create().texOffs(1, 5).addBox(28.431F, -0.4249F, 3.164F, 20.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(13.6411F, -39.4259F, 1.2251F));
