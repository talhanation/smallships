...
public class CaravelModel extends ShipModel<CaravelEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bottom.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(48.0F, 0.0F, -10.0F, 3.0F, 9.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(48.0F, -9.0F, -10.0F, 3.0F, 9.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(48.0F, 0.0F, -5.0F, 3.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(48.0F, -9.0F, -5.0F, 3.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
				...
				.texOffs(1, 1).addBox(37.0F, 0.0F, -5.0F, 11.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(37.0F, -9.0F, -5.0F, 11.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(21.0F, 0.0F, -5.0F, 16.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(21.0F, -13.0F, -5.0F, 16.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(10.0F, 13.0F, -5.0F, 11.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(10.0F, 0.0F, -5.0F, 11.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(10.0F, -16.0F, -5.0F, 11.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(10.0F, -13.0F, -5.0F, 11.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-9.0F, 13.0F, -5.0F, 19.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-9.0F, 0.0F, -5.0F, 19.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-9.0F, -16.0F, -5.0F, 19.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-9.0F, -13.0F, -5.0F, 19.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-28.0F, 13.0F, -5.0F, 19.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-28.0F, 0.0F, -5.0F, 19.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-28.0F, -16.0F, -5.0F, 19.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-28.0F, -13.0F, -5.0F, 19.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-36.0F, 0.0F, -5.0F, 8.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(1, 1).addBox(-36.0F, -13.0F, -5.0F, 8.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
				...
				.texOffs(1, 1).addBox(37.0F, 0.0F, -1.0F, 14.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r2 = bottom.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-36.0F, 3.0F, -5.5F, 8.0F, 6.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(21.0F, 3.0F, -5.5F, 16.0F, 7.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(10.0F, 5.0F, -5.5F, 11.0F, 5.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-9.0F, 5.0F, -5.5F, 19.0F, 5.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-28.0F, 5.0F, -5.5F, 19.0F, 5.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-36.0F, 9.0F, -5.5F, 8.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -10.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r3 = bottom.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(2, 0).addBox(-34.0F, 3.0F, -5.5F, 14.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, -16.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r4 = bottom.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(11, 9).addBox(-43.0F, -13.0F, -10.0F, 4.0F, 22.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -7.0F, -4.0F, -1.5708F, -1.5708F, 0.0F));

		PartDefinition cube_r5 = bottom.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(11, 3).addBox(-43.0F, -13.0F, -10.0F, 7.0F, 13.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r6 = bottom.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(8, 0).addBox(-43.0F, 0.0F, -10.0F, 7.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -7.0F, -1.5708F, -1.5708F, 0.0F));

		PartDefinition cube_r7 = bottom.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 0).addBox(21.0F, -13.0F, -5.0F, 16.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -9.0F, 0.0F, -1.5708F, -1.5708F, 0.0F));

		PartDefinition cube_r8 = bottom.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 0).addBox(21.0F, 0.0F, -5.0F, 16.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.0F, 0.0F, -1.5708F, -1.5708F, 0.0F));
		...
		PartDefinition cube_r9 = front.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(13, 3).addBox(-11.1964F, -9.1568F, -4.1F, 12.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, -15.0F, -1.5708F, -1.5708F, 1.5708F));

		PartDefinition cube_r10 = front.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(20, 4).addBox(-10.1964F, -7.1568F, -3.1F, 9.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -8.5F, -25.1F, -1.5708F, -1.0908F, 1.5708F));
		...
		PartDefinition cube_r21 = sides.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(7, 39).addBox(-15.5F, -1.5F, 0.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(11, 43).addBox(-15.5F, -1.5F, -4.0F, 8.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.5F, -22.0F, -51.5F, -1.5708F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r24 = sides.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(16, 40).addBox(-15.0F, -19.0F, -17.0F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(29.0F, -9.0F, -35.0F, -1.5708F, -1.5708F, 0.0F));

		PartDefinition cube_r25 = sides.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(16, 41).addBox(-15.0F, -19.0F, -17.0F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(16, 41).addBox(-8.0F, -22.0F, -17.0F, 7.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, -9.0F, -35.0F, -1.5708F, -1.5708F, 0.0F));
		...
		PartDefinition cube_r32 = sides.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(3, 43).addBox(-10.5F, 6.5F, 0.0F, 20.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -26.0F, -56.5F, -1.5708F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r34 = sides.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(3, 43).addBox(-10.5F, 6.5F, 0.0F, 20.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -26.0F, -59.5F, -1.5708F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r63 = mast_2.addOrReplaceChild("cube_r63", CubeListBuilder.create().texOffs(0, 47).addBox(-11.7387F, -5.6338F, -5.4179F, 5.3726F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r71 = mast_1.addOrReplaceChild("cube_r71", CubeListBuilder.create().texOffs(2, 47).addBox(-63.6274F, -1.0F, 0.1F, 22.6274F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(32.976F, -12.3466F, -27.8654F, 0.7903F, 0.6178F, 1.05F));

		PartDefinition cube_r72 = mast_1.addOrReplaceChild("cube_r72", CubeListBuilder.create().texOffs(2, 47).addBox(-63.6274F, -1.0F, 0.1F, 22.6274F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(23.9011F, -28.1716F, -14.8904F, 0.7903F, 0.6178F, 1.05F));

		PartDefinition cube_r73 = mast_1.addOrReplaceChild("cube_r73", CubeListBuilder.create().texOffs(2, 47).addBox(-63.6274F, -1.0F, 0.1F, 22.6274F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.751F, -44.0966F, -1.8404F, 0.7903F, 0.6178F, 1.05F));

		PartDefinition cube_r74 = mast_1.addOrReplaceChild("cube_r74", CubeListBuilder.create().texOffs(2, 47).addBox(-63.6274F, -1.0F, 0.1F, 22.6274F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.551F, -60.0716F, 11.2846F, 0.7903F, 0.6178F, 1.05F));

		PartDefinition cube_r75 = mast_1.addOrReplaceChild("cube_r75", CubeListBuilder.create().texOffs(0, 47).addBox(-65.0F, -1.0F, 0.1F, 24.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.649F, -76.0716F, 24.3846F, 0.7903F, 0.6178F, 1.05F));

		PartDefinition cube_r76 = mast_1.addOrReplaceChild("cube_r76", CubeListBuilder.create().texOffs(0, 45).addBox(-63.6274F, -1.0F, -1.9F, 22.6274F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r77 = mast_1.addOrReplaceChild("cube_r77", CubeListBuilder.create().texOffs(1, 37).addBox(-13.5F, -0.5F, -1.5F, 27.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -89.5F, 29.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r78 = mast_1.addOrReplaceChild("cube_r78", CubeListBuilder.create().texOffs(0, 36).addBox(-13.5F, -1.5F, -1.5F, 27.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -62.5F, 28.5F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r79 = mast_1.addOrReplaceChild("cube_r79", CubeListBuilder.create().texOffs(0, 36).addBox(-13.5F, -1.5F, -1.5F, 27.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -35.5F, 28.5F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r80 = mast_1.addOrReplaceChild("cube_r80", CubeListBuilder.create().texOffs(0, 36).addBox(-13.5F, -1.5F, -1.5F, 27.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.5F, 28.5F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r81 = steer.addOrReplaceChild("cube_r81", CubeListBuilder.create().texOffs(3, 29).addBox(51.0F, -1.0F, -10.0F, 8.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 13.0F, -55.0F, -1.5708F, -1.5708F, 0.0F));

		PartDefinition cube_r82 = steer.addOrReplaceChild("cube_r82", CubeListBuilder.create().texOffs(2, 28).addBox(51.0F, -2.0F, -11.0F, 3.0F, 4.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 13.0F, -58.0F, -1.5708F, -1.5708F, 0.0F));
