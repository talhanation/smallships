...
public class GalleonSailModel extends SailModel {
	...
	private final ModelPart sail_front_top_front_bottom;
	private final ModelPart sail_front_top_2;
	private final ModelPart sail_front_top_main_bottom;
	...
	private final ModelPart sail_main_front_bottom;
	private final ModelPart sail_main_2;
	private final ModelPart sail_main_main_bottom;
	...
	private final ModelPart sail_main_top_front_bottom;
	private final ModelPart sail_main_top_2;
	private final ModelPart sail_main_top_main_bottom;
	...
	private final ModelPart sail_front_front_bottom;
	private final ModelPart sail_front_2;
	private final ModelPart sail_front_main_bottom;
	...
	private final ModelPart sail_back_main_bottom;
	...
	private final ModelPart sail_back_front_bottom;
	private final ModelPart Base40;
	private final ModelPart rope_sail_main_top_front_1;
	private final ModelPart rope_sail_main_top_main_1;
	private final ModelPart rope_sail_main_top_3_1;
	private final ModelPart rope_sail_main_top_4_1;
	private final ModelPart rope_sail_front_top_front_1;
	private final ModelPart rope_sail_front_top_main_1;
	private final ModelPart rope_sail_front_top_3_1;
	private final ModelPart rope_sail_front_top_4_1;
	private final ModelPart rope_sail_main_top_front_2;
	private final ModelPart rope_sail_main_top_main_2;
	private final ModelPart rope_sail_main_top_3_2;
	private final ModelPart rope_sail_main_top_4_2;
	private final ModelPart rope_sail_front_top_front_2;
	private final ModelPart rope_sail_front_top_main_2;
	...
	public GalleonSailModel() {
		...
		this.sail_front_top_front_bottom = this.sail_front_top_1.getChild("sail_front_top_front_bottom");
		this.sail_front_top_2 = this.sail_front_top.getChild("sail_front_top_2");
		this.sail_front_top_main_bottom = this.sail_front_top_2.getChild("sail_front_top_main_bottom");
		...
		this.sail_main_front_bottom = this.sail_main_1.getChild("sail_main_front_bottom");
		this.sail_main_2 = this.sail_main.getChild("sail_main_2");
		this.sail_main_main_bottom = this.sail_main_2.getChild("sail_main_main_bottom");
		...
		this.sail_main_top_front_bottom = this.sail_main_top_1.getChild("sail_main_top_front_bottom");
		this.sail_main_top_2 = this.sail_main_top.getChild("sail_main_top_2");
		this.sail_main_top_main_bottom = this.sail_main_top_2.getChild("sail_main_top_main_bottom");
		...
		this.sail_front_front_bottom = this.sail_front_1.getChild("sail_front_front_bottom");
		this.sail_front_2 = this.sail_front.getChild("sail_front_2");
		this.sail_front_main_bottom = this.sail_front_2.getChild("sail_front_main_bottom");
		...
		this.sail_back_main_bottom = this.sail_back_2.getChild("sail_back_main_bottom");
		this.Base34 = this.sail_back_main_bottom.getChild("Base34");
		...
		this.sail_back_front_bottom = this.sail_back_1.getChild("sail_back_front_bottom");
		this.Base40 = this.sail_back_front_bottom.getChild("Base40");
		this.rope_sail_main_top_front_1 = this.GalleonSail.getChild("rope_sail_main_top_front_1");
		this.rope_sail_main_top_main_1 = this.GalleonSail.getChild("rope_sail_main_top_main_1");
		...
		this.rope_sail_front_top_front_1 = this.GalleonSail.getChild("rope_sail_front_top_front_1");
		this.rope_sail_front_top_main_1 = this.GalleonSail.getChild("rope_sail_front_top_main_1");
		...
		this.rope_sail_main_top_front_2 = this.GalleonSail.getChild("rope_sail_main_top_front_2");
		this.rope_sail_main_top_main_2 = this.GalleonSail.getChild("rope_sail_main_top_main_2");
		...
		this.rope_sail_front_top_front_2 = this.GalleonSail.getChild("rope_sail_front_top_front_2");
		this.rope_sail_front_top_main_2 = this.GalleonSail.getChild("rope_sail_front_top_main_2");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition sail_front_top_front_bottom = sail_front_top_1.addOrReplaceChild("sail_front_top_front_bottom", CubeListBuilder.create().texOffs(64, 54).addBox(20.0F, -2.5F, -5.0F, 14.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition sail_front_top_main_bottom = sail_front_top_2.addOrReplaceChild("sail_front_top_main_bottom", CubeListBuilder.create().texOffs(64, 56).addBox(20.5F, -2.0F, -4.0F, 14.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition sail_main_front_bottom = sail_main_1.addOrReplaceChild("sail_main_front_bottom", CubeListBuilder.create().texOffs(64, 45).addBox(34.5F, -2.5F, -5.0F, 13.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition sail_main_main_bottom = sail_main_2.addOrReplaceChild("sail_main_main_bottom", CubeListBuilder.create().texOffs(64, 42).addBox(34.5F, -2.0F, -4.0F, 13.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition sail_main_top_front_bottom = sail_main_top_1.addOrReplaceChild("sail_main_top_front_bottom", CubeListBuilder.create().texOffs(64, 39).addBox(20.0F, -2.5F, -5.0F, 14.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition sail_main_top_main_bottom = sail_main_top_2.addOrReplaceChild("sail_main_top_main_bottom", CubeListBuilder.create().texOffs(64, 28).addBox(20.5F, -2.0F, -4.0F, 14.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition sail_front_front_bottom = sail_front_1.addOrReplaceChild("sail_front_front_bottom", CubeListBuilder.create().texOffs(64, 54).addBox(27.5F, -2.5F, -5.0F, 14.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition sail_front_main_bottom = sail_front_2.addOrReplaceChild("sail_front_main_bottom", CubeListBuilder.create().texOffs(64, 43).addBox(27.5F, -2.0F, -4.0F, 14.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition sail_back_main_bottom = sail_back_2.addOrReplaceChild("sail_back_main_bottom", CubeListBuilder.create(), PartPose.offset(-0.2F, -32.0F, -11.5F));

		PartDefinition Base34 = sail_back_main_bottom.addOrReplaceChild("Base34", CubeListBuilder.create().texOffs(64, 0).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1047F, 0.0F));
		...
		PartDefinition sail_back_front_bottom = sail_back_1.addOrReplaceChild("sail_back_front_bottom", CubeListBuilder.create(), PartPose.offset(-0.2F, -48.0F, 4.5F));

		PartDefinition Base40 = sail_back_front_bottom.addOrReplaceChild("Base40", CubeListBuilder.create().texOffs(64, 0).addBox(-2.5F, 0.0F, 0.0F, 5.0F, 5.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1047F, 0.0F));

		PartDefinition rope_sail_main_top_front_1 = GalleonSail.addOrReplaceChild("rope_sail_main_top_front_1", CubeListBuilder.create(), PartPose.offsetAndRotation(-44.0641F, -37.9027F, 9.8343F, 0.1881F, -0.0238F, 0.2555F));

		PartDefinition cube_r83_r1 = rope_sail_main_top_front_1.addOrReplaceChild("cube_r83_r1", CubeListBuilder.create().texOffs(7, 25).addBox(-31.0F, -0.5F, -0.5F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rope_sail_main_top_main_1 = GalleonSail.addOrReplaceChild("rope_sail_main_top_main_1", CubeListBuilder.create(), PartPose.offsetAndRotation(-44.0641F, -37.9027F, 9.8343F, 0.3271F, 0.0001F, 0.3534F));

		PartDefinition cube_r83_r2 = rope_sail_main_top_main_1.addOrReplaceChild("cube_r83_r2", CubeListBuilder.create().texOffs(7, 25).addBox(-25.0F, -0.5F, -0.5F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(7, 25).addBox(-12.0F, -0.5F, -0.5F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0283F, -2.1273F, 1.0822F, 0.0F, 0.0F, 1.6581F));
		...
		PartDefinition rope_sail_front_top_front_1 = GalleonSail.addOrReplaceChild("rope_sail_front_top_front_1", CubeListBuilder.create(), PartPose.offsetAndRotation(-41.0641F, -19.9027F, -44.1657F, 0.1874F, 0.018F, 0.1526F));

		PartDefinition cube_r84_r1 = rope_sail_front_top_front_1.addOrReplaceChild("cube_r84_r1", CubeListBuilder.create().texOffs(23, 26).addBox(-29.0F, -0.5F, -0.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rope_sail_front_top_main_1 = GalleonSail.addOrReplaceChild("rope_sail_front_top_main_1", CubeListBuilder.create(), PartPose.offsetAndRotation(-41.0641F, -19.9027F, -44.1657F, 0.3463F, 0.0471F, 0.2366F));

		PartDefinition cube_r84_r2 = rope_sail_front_top_main_1.addOrReplaceChild("cube_r84_r2", CubeListBuilder.create().texOffs(23, 26).addBox(-22.0F, -0.5F, -0.5F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rope_sail_main_top_front_2 = GalleonSail.addOrReplaceChild("rope_sail_main_top_front_2", CubeListBuilder.create(), PartPose.offsetAndRotation(44.9359F, -37.9027F, 10.2343F, 0.2051F, -0.14F, -0.4673F));

		PartDefinition cube_r84_r5 = rope_sail_main_top_front_2.addOrReplaceChild("cube_r84_r5", CubeListBuilder.create().texOffs(16, 24).addBox(-31.0F, -0.5F, -0.5F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rope_sail_main_top_main_2 = GalleonSail.addOrReplaceChild("rope_sail_main_top_main_2", CubeListBuilder.create(), PartPose.offsetAndRotation(44.9359F, -37.9027F, 10.2343F, 0.3496F, -0.1349F, -0.5892F));

		PartDefinition cube_r84_r6 = rope_sail_main_top_main_2.addOrReplaceChild("cube_r84_r6", CubeListBuilder.create().texOffs(16, 24).addBox(-25.0F, -0.5F, -0.5F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(16, 24).addBox(-12.0F, -0.5F, -0.5F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0283F, -2.1273F, 1.0822F, 0.0F, 0.0F, 1.6581F));
		...
		PartDefinition rope_sail_front_top_front_2 = GalleonSail.addOrReplaceChild("rope_sail_front_top_front_2", CubeListBuilder.create(), PartPose.offsetAndRotation(41.9359F, -19.9027F, -43.7657F, 0.2327F, -0.1914F, -0.413F));

		PartDefinition cube_r85_r1 = rope_sail_front_top_front_2.addOrReplaceChild("cube_r85_r1", CubeListBuilder.create().texOffs(21, 26).addBox(-30.0F, -0.5F, -0.5F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rope_sail_front_top_main_2 = GalleonSail.addOrReplaceChild("rope_sail_front_top_main_2", CubeListBuilder.create(), PartPose.offsetAndRotation(41.9359F, -19.9027F, -43.7657F, 0.3908F, -0.1816F, -0.53F));

		PartDefinition cube_r85_r2 = rope_sail_front_top_main_2.addOrReplaceChild("cube_r85_r2", CubeListBuilder.create().texOffs(21, 26).addBox(-24.0F, -0.5F, -0.5F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
	...
	public void setupAnim(@NotNull Ship cog, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		switch (cog.getData(Ship.SAIL_STATE)) {
			case 0 -> {
				...
				this.sail_front_main_bottom.visible = false;
				...
				this.sail_main_front_bottom.visible = false;
			...
			case 1 -> {
				...
				this.sail_main_front_bottom.visible = true;
				//this.sail_main_2_bottom.visible = false;
				this.sail_main_3_bottom.visible = false;
			}
			case 2 -> {
				...
				this.sail_front_4.visible = false;
				//this.sail_front_1_bottom.visible = false;
				this.sail_front_main_bottom.visible = true;
				this.sail_front_3_bottom.visible = false;
...
/*
        ...
        this.rope_7.visible = sail_front_bottom.visible;
        this.rope_8.visible = sail_front_bottom.visible;

        this.rope_11.visible = sail_main_bottom.visible;
        this.rope_12.visible = sail_main_bottom.visible;
