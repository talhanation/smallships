...
public class GalleonMastBannerModel extends MastBannerModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition ModelGalleonMastBanner = partdefinition.addOrReplaceChild("ModelGalleonMastBanner", CubeListBuilder.create(), PartPose.offset(2.5F, -141.0F, -0.5F));

        PartDefinition cloth = ModelGalleonMastBanner.addOrReplaceChild("cloth", CubeListBuilder.create(), PartPose.offsetAndRotation(0.5F, 2.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
