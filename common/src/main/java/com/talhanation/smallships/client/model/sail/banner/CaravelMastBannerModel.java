...
public class CaravelMastBannerModel extends MastBannerModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition CaravelMastBanner = partdefinition.addOrReplaceChild("CaravelMastBanner", CubeListBuilder.create(), PartPose.offset(-27.6F, -95.0F, 0.0F));

        PartDefinition cloth = CaravelMastBanner.addOrReplaceChild("cloth", CubeListBuilder.create(), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
