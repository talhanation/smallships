...
public class KhufuModel extends ShipModel<KhufuEntity> {
	...
	@Override
	public void setupAnim(@NotNull KhufuEntity khufuEntity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.steer.yRot = -((BoatAccessor) khufuEntity).getDeltaRotation() * 0.25F;
	}
