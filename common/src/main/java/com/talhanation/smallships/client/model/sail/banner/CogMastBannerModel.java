 ...
 */
public class CogMastBannerModel extends MastBannerModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition ModelCogMastBanner = partdefinition.addOrReplaceChild("ModelCogMastBanner", CubeListBuilder.create(), PartPose.offset(0.5F, -63.0F, 0.0F));

        PartDefinition cloth = ModelCogMastBanner.addOrReplaceChild("cloth", CubeListBuilder.create(), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
